<?php
    ...
    $id = (isset($_GET['user_id_up'])) ? $_GET['user_id_up'] : 0; //Operador Condicional(if) ternario
    $id=limpiar_cadena($id);
?>
<div class="container is-fluid mb-6">

    <!-- Esta condición es para que el título de la página sea 
    dinámico cuando estamos ubicados en la vista (mi cuenta) 
    ó en el caso de que vayamos a actualizar datos de otro usuario.
    El navbar con el boton (mi cuenta) ya fue actualizado-->
...
<div class="container pb-6 pt-6">
	<?php
        ...
        if($check_usuario->rowCount()>0){
        	$datos=$check_usuario->fetch(); //Seleccionamos un solo usuario/elemento, ponemos fetch si es más de uno fetchAll.
	?>

	<div class="form-rest mb-6 mt-6"></div>
            <!-- Con $datos traemos toda la info de la db del usuario y la colocamos como value= en los inputs del form -->
	<form action="./php/usuario_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
            <!-- Enviamos a ./php/usuario_actualizar.php ['usuario_id'] con el POST -->
