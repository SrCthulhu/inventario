...
<div class="container pb-6 pt-6">
	...
	<!--enctype="multipart/form-data" nos permite enviar en el método post imágenes-->
		  	...
		  	<div class="column">
		    	...
		    	<div class="select is-rounded">
				  	<select name="producto_categoria" >
						...
						<!--Mostramos en el dropdown las categorias agregadas en el db
						Creamos un array de datos con fetchAll y recorremos con el foreach-->
				    	<?php
    						$categorias=conexion();
