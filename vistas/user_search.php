...
<div class="container pb-6 pt-6">
    <?php                       // El segundo if de PHP se conecta con el código PHP de abajo.
        require_once "./php/main.php";

        if(isset($_POST['modulo_buscador'])){  
            require_once "./php/buscador.php";
        }
        // Validamos si viene definida la variable de sesion 'busqueda_usuario' o si está vacía
        if(!isset($_SESSION['busqueda_usuario']) && empty($_SESSION['busqueda_usuario'])){  
    ?>
    <div class="columns">
        <div class="column">
            <!--El "action" del formulario está vacío porque se recargará la misma página-->
