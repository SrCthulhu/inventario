...
<div class="container pb-6 pt-6">
	<?php
		...
		$id = (isset($_GET['product_id_up'])) ? $_GET['product_id_up'] : 0; //Operador ternario.
	...
	<div class="columns">
		<div class="column is-two-fifths">
			<?php if(is_file("./img/producto/".$datos['producto_foto'])){ ?> <!--Verificamos si la imagen existe o no-->
		...
		<div class="column">
			<form class="mb-6 has-text-centered FormularioAjax" action="./php/producto_img_actualizar.php" 
