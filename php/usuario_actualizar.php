<?php
    ...
    /*== Almacenando datos del administrador, recordar que vienen en el POST del formulario de user_update.php ==*/
    ...
    // la funcion password_verify() desencripta para ver si coincide con la proporcionada en el formulario con el db.
    ...
    /*== Verificando email ==*/
    if($email!="" && $email!=$datos['usuario_email']){ // Si el email es distinto a una cadena vacía y es distinto al email de la base de datos.
